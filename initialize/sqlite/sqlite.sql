...
CREATE TABLE IF NOT EXISTS "certificate" (
  ...
  -- x509 extensions as comma separated text because sqlite3 can't handle arrays
  extension TEXT,
...
CREATE INDEX certificate_serial_number_idx ON certificate (serial_number, fingerprint_md5, fingerprint_sha1, state, issuer, subject);
